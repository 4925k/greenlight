...
type Movie struct {
	...
	Runtime   Runtime   `json:"runtime,omitempty"` // string - 100 mins
	Genres    []string  `json:"genres,omitempty"`
	Version   int32     `json:"version"`
}

func ValidateMovie(v *validator.Validator, movie *Movie) {
	// using validator to check for body values
	...
	v.Check(movie.Runtime > 0, "runtime", "must be positve integer")
...
// Insert helps to insert a new record
